...
class EditorWidget(secondary_widget.SecondaryWidget):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        img_btn_widget = QtWidgets.QWidget()
        img_btn_widget.setLayout(img_btn_layout)
        right_layout.addWidget(img_btn_widget)
